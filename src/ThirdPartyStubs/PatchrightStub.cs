...
namespace Patchright
{
    ...
    public sealed class ClickOptions { public string? Button; public int ClickCount; public int Delay; public string[] Modifiers = Array.Empty<string>(); }
    public sealed class TypeOptions { public int Delay; }
    public sealed class WaitForSelectorOptions { public int Timeout; public WaitState State; }
    public sealed class ScreenshotOptions { public string? Type; public int? Quality; public bool FullPage; }
    public sealed class NavigationOptions { public int Timeout; public WaitUntil WaitUntil; }

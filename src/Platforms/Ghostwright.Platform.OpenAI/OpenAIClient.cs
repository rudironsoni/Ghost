...
/// <summary>
/// Browser-driven client that automates chatgpt.com via the Ghostwright browser kernel.
/// </summary>
public sealed partial class OpenAIClient : Ghostwright.Contracts.Inference.IInferenceClient
{

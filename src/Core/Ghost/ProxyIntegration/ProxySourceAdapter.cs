...
{
    private readonly Ghost.Core.ProxySourceConfig _config;
    ...
    {
        var coreConfig = new Ghost.Core.ProxySourceConfig
        {
...
{
    private readonly List<Ghost.Core.ProxySourceConfig> _sourcesChain;
    ...
    public ProxySourceFallbackManager(
        List<Ghost.Core.ProxySourceConfig> sourcesChain,

...
6. `.env.example`
7. `.sisyphus/plans/fix-job-platforms-comprehensive.md`
8. `.sisyphus/notepads/fix-job-platforms-comprehensive/learnings.md`
...
8. `.sisyphus/notepads/fix-job-platforms-comprehensive/session_summary_final.md`

...
This document lists all commits that touch `docs/plan/`, `docs/archive/2026-02-02-181914-initial-state/`, or have commit messages containing "docs", "plan", "adr", "decision", or "sisyphus".

...
public class PeriodicStatsLoggingTests
{
    ...
    {
        // Act
        var extension = new PeriodicStatsLogging(_statsCollector, _logger);
    ...
    {
        // Act
        var act = () => new PeriodicStatsLogging(null!, _logger);
    ...
    {
        // Act
        var act = () => new PeriodicStatsLogging(_statsCollector, null!);
    ...
    [Fact]
    public async Task StartLogging_TriggersPeriodicStatCollection()
    {
        // Arrange
        ...
        // Act
        extension.StartLogging("test-spider");
        await Task.Delay(250); // Wait for at least 2 timer ticks
        extension.StopLogging();
    ...
    [Fact]
    public async Task StartLogging_LogsStatsWithCorrectValues()
    {
        // Arrange
        var stats = new SpiderStats
        {
    ...
    [Fact]
    public async Task StartLogging_WithStatsCollectorException_DoesNotCrash()
    {
        // Arrange
    ...
    [Fact]
    public async Task StartLogging_CalledTwice_RestartTimer()
    {
        // Arrange
    ...
    [Fact]
    public async Task StartLogging_WithZeroStats_LogsSuccessfully()
    {
        // Arrange
        var stats = new SpiderStats
        {
    ...
    [Fact]
    public async Task StartLogging_WithCustomInterval_RespectsInterval()
    {
        // Arrange
        ...
        // Act
        extension.StartLogging("test-spider");
        await Task.Delay(100); // Less than interval
        var callsBeforeInterval = _statsCollector.ReceivedCalls().Count();

        await Task.Delay(150); // Now past interval
    ...
    [Fact]
    public async Task StartLogging_WithLongRunningStats_ContinuesLogging()
    {
        // Arrange
        var callCount = 0;
        ...
        // Act
        extension.StartLogging("test-spider");
        await Task.Delay(350); // Should trigger 3-4 timer ticks
        extension.StopLogging();

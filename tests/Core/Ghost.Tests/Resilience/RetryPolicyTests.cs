...
public class RetryPolicyTests
{
    ...
    public async Task ExecuteAsyncSucceedsWithoutRetries()
    {
        ...
        var result = await policy.ExecuteAsync(async () => await Task.FromResult(42), _ => true);
    ...
    public async Task ExecuteHttpAsyncRetriesOnHttpRequestException()
    {
        ...
        var act = async () => await policy.ExecuteHttpAsync(async () =>
        {
            attempts++;
            throw new HttpRequestException("transient");
        });
    ...
    public async Task ExecuteHttpAsyncRetriesOnRetryableStatusCode()
    {
        ...
        var response = await policy.ExecuteHttpAsync(async () =>
        {
            attempts++;
    ...
    public async Task ExecuteHttpAsyncThrowsWhenActionReturnsNull()
    {
        ...
        var act = async () => await policy.ExecuteHttpAsync(async () => await Task.FromResult<HttpResponseMessage>(null!));
    ...
    public async Task ExecuteAsyncPreservesAmbientAttemptValue()
    {
        ...
        var outerAttempt = await policy.ExecuteAsync(async () =>
        {
    ...
    public async Task ExecuteAsyncInvalidOptionsThrow()
    {
        ...
        var act = async () => await policy.ExecuteAsync(async () => await Task.FromResult(1), _ => true);

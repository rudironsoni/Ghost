...
public interface IProviderContractAdapter
{
    ...
    /// </summary>
    Task<IReadOnlyList<JobListing>> GetJobsAsync(JobSearchCriteria criteria, CancellationToken ct = default);
    ...
    /// </summary>
    Task<IReadOnlyList<JobListing>> SearchWithPaginationAsync(
    ...
    /// </summary>
    Task<IReadOnlyList<JobListing>> TestRetryBehaviorAsync(
        JobSearchCriteria criteria,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<IReadOnlyList<JobListing>> TestConsentFlowAsync(
        JobSearchCriteria criteria,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<(IReadOnlyList<JobListing> First, IReadOnlyList<JobListing> Second)> TestIdempotencyAsync(
        JobSearchCriteria criteria,
        CancellationToken ct = default);
}

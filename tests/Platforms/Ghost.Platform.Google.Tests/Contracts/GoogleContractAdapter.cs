...
/// <summary>
/// Adapter for Google provider contract testing.
/// </summary>
public sealed class GoogleContractAdapter : IProviderContractAdapter
{
    private readonly IJobClient _jobClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="GoogleContractAdapter"/> class.
    /// </summary>
    public GoogleContractAdapter(IJobClient jobClient)
    {
        ...
        CancellationToken ct = default)
    {
        ...
        for (int page = 0; page < maxPages; page++)
        {
            var pageCriteria = new JobSearchCriteria
            {
                ...
                // Google-specific pagination would go here
            };

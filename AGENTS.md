...
- `TEST_FAST`: `dotnet test Ghost.sln --no-build --filter "Category!=Smoke&Category!=End2End&Category!=E2E"`
- `TEST_FAST_FALLBACK`: `dotnet test Ghost.sln --filter "Category!=Smoke&Category!=End2End&Category!=E2E"`
